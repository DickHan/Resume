...
### 2024.4-至今 | 中建四局安装工程有限公司智控与数字科技事业部 | 30000+人 | 软件开发组负责人

智控事业部专注于建筑企业办公生产过程的数字化转型业务，负责开发数字化信息系统，应用数字化、物联网、人工智能等信息技术赋能建筑行业的设计、施工、商务、技术管理、人力资源等领域。
...
### 2023.7-2024.4 | 深圳市海苔科技有限公司 | 50人 | 兼职
...
云上书院是一款面向小学学生、家长、老师和学校的分级阅系统。系统整合了有专业团队联合小学阅读专家学者倾力打造的独家内容资源。学生可以使用电脑和手机等设备使用云上书院的平台，获取优秀的阅读资源，通过科学的分级阅读体系培养终生阅读的习惯。平台后端还能通过全面丰富的阅读数据统计，让家长了解学生的阅读成效，让老师和学校科学客观的评估阅读教育水平，制定更有效的舆情教学，推动学生进一步培养阅读水平。

技术栈
- Java、MySql、SpringBoot、Nacos、Sentinel、Docker、Redis、RabbitMq、ES
