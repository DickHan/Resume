...
针对委办局具体需求，对接数据服务平台，从DM数据超市获取数据，建立ADS层应用数据，并基于应用数据开发业务系统，实现跨局的业务数据应用、分析以及展示。
...
### 2017.9-2018.3 | 广东世纪晓教育科技有限公司 | 10000以上 | 数据开发工程师

公司后台运营系统财务、人力资源报表功能开发。


1. 公司后台报表数据需求分析，数据仓库模型设计
1. 公共数据整合，标准化处理。
1. reenplum数据仓库扩展及优化。
1. 用户数据过滤、聚合、导入及离线分析。
**​**
